...
const products = [
  ...
  },
  {
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=800&q=80', public_id: 'wool1' }],
    sizes: ['M', 'L', 'XL'],
    isFeatured: true,
  },
  {
  ...
  },
  {
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=800&q=80', public_id: 'trousers1' }],
    sizes: ['S', 'M', 'L', 'XL'],
    isFeatured: true,
  },
  {
  ...
  },
  {
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1520639888713-7851133b1ed0?w=800&q=80', public_id: 'boots1' }],
    sizes: ['M', 'L', 'XL'],
    isFeatured: false,
  },
  {
  ...
  },
  {
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1581655353564-df123a1eb820?w=800&q=80', public_id: 'polo1' }],
    sizes: ['S', 'M', 'L', 'XL'],
    isFeatured: false,
  },
  // WOMEN
